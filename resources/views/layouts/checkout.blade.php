        ...
        <nav class="row navbar navbar-expand-lg navbar-light bg-white">
            <div class="navbar-nav ml-auto mr-auto mr-sm-auto mr-lg-0 mr-md-auto">
                <a href="index.html" class="navbar-brand">
                    <img src="images/logo_nomads.png" alt="logo">
                </a>
            </div>
                            ...
                            <div class="attendee">
                                <table class="table table-responsive-sm text-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="images/testimonial-1.jpg" alt="avatar-1" height="60" class="rounded-circle">
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <a href="#">
                                                    <img src="images/ic_remove.png" alt="remove">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <img src="images/testimonial-2.jpg" alt="avatar-1" height="60" class="rounded-circle">
                                            </td>
                                            <td class="align-middle">
                                                Kevin Sanjaya
                                            </td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.datepicker').datepicker({
                ...
                icons: {
                    rightIcon: '<img src="images/ic_date.png">'
                }
            })
        });
    </script>
