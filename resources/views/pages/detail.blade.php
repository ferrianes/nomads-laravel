                        ...
                        <div class="card card-details">
                            ...
                            <div class="gallery">
                                <div class="xzoom-container">
                                    <img src="{{ Storage::url($item->galleries->first()->images) }}" class="xzoom" id="xzoom-default" xoriginal="{{ Storage::url($item->galleries->first()->images) }}">
                                    <div class="xzoom-thumbs">
                                        @foreach ($item->galleries as $gallery)
                                            <a href="{{ Storage::url($gallery->images) }}">
                                                <img src="{{ Storage::url($gallery->images) }}" class="xzoom-gallery" width="128" xpreview="{{ Storage::url($gallery->images) }}">
                                            </a>
                                        @endforeach
                                    </div>
                                </div>
